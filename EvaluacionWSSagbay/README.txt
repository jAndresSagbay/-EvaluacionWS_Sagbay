...
a persistence unit "EvaluacionWSSagbayPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSSagbay\pom.xml":
...
artifact ("EvaluacionWSSagbay.war") is already built. You can build
